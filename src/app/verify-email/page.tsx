                ...
                <Card className="w-full max-w-md mx-auto shadow-2xl">
                    <CardHeader className="text-center">
                         <Link href="/" className="flex justify-center items-center gap-2 mb-2 group">
                            <BookMarked className="h-10 w-10 text-primary group-hover:text-primary/80 transition-colors" aria-label="B-Tech Hub Logo" />
                        ...
                        <CardTitle className="font-headline text-2xl flex items-center justify-center gap-2">
                           <Mail className="h-6 w-6" aria-label="Mail Icon" /> Check Your Email
                        </CardTitle>
                        <CardDescription>
